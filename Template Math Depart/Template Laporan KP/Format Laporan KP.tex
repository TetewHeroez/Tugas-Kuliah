...
\begin{longtable}{|c|>{\centering\arraybackslash}p{0.31\linewidth}|>{\raggedright\arraybackslash}p{0.4\linewidth}|}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{foto/sejarah mpl.png}
    \caption{RRQ \#7}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%  Lampiran %%%%%%%%%%%%%%%5%%%%%%%%%%
