...
\providecommand{\algoritmaautorefname}{Algoritma}
\providecommand{\catatanautorefname}{Catatan}
...
\LembarPengesahanEng
\LembarOrisinalitas
\LembarOrisinalitasEng


%%%%%%%%%%%%%%%%%%%%%%%%  Abstrak  %%%%%%%%%%%%%%%5%%%%%%%%%%
\LembarAbstrak{Inti/abstrak}
\LembarAbstract{Inti/abstract}
\KataPengantar{Inti/kata-pengantar}
...
\DaftarLampiran
%%%%%%%%%%%%%%%%%%%%%%%%  Lampiran  %%%%%%%%%%%%%%%5%%%%%%%%%%
\UcapanTerimaKasih{Inti/ucapan-terima-kasih}
