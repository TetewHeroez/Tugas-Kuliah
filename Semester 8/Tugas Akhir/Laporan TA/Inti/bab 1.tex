...
\begin{enumerate}
  ...
  \item Bagaimana cara mengonstruksi \textit{Latin square} $B$ sehingga $A \otimes B = B \otimes A$ untuk suatu \textit{Latin square} $A$?
...
\begin{enumerate}
  ...
  \item Merumuskan prosedur untuk mengonstruksi \textit{Latin square} $B$ sehingga $A \otimes B = B \otimes A$ untuk suatu \textit{Latin square} $A$.
