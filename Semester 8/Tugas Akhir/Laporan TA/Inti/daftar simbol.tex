...
<<<<<<< HEAD
  ...
  $\underline{n}$            & : Himpunan simbol $\{1,2,\ldots,n\}$                                                               \\
  $L_S(n)$                   & : Himpunan semua Latin square berordo $n$ dengan himpunan simbol $\underline{n}$                   \\
  ...
  $\Gamma(\sigma)$           & : Representasi koordinat dari permutasi $\sigma$, yaitu $\{(r,\sigma(r))\mid r\in \underline{n}\}$ \\
