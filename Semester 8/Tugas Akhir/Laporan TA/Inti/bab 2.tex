...
Misalkan $S$ adalah himpunan simbol dengan kardinalitas $n$. Himpunan semua \textit{Latin square} berordo $n$ yang dibangun menggunakan simbol-simbol dari $S$ dinotasikan sebagai $L_S(n)$. Secara khusus, jika himpunan simbol yang digunakan adalah $S=\{a_1, a_2, \ldots, a_n\}$, maka sebuah \textit{Latin square} $A \in L_S(n)$ merupakan matriks $n \times n$ di mana setiap entri $a_{ij} \in \{a_1, a_2, \ldots, a_n\}$ dan setiap simbol $a_k$ muncul tepat satu kali pada setiap baris dan setiap kolom.
