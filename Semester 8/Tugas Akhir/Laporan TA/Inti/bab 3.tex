...
Investigasi dilakukan dengan membandingkan struktur pasangan \textit{Latin square} komutatif menggunakan \autoref{prop:dekomposisi_latin_square} yang telah dijelaskan pada bab 2. Hal tersebut bertujuan untuk mememudahkan dalam menemukan sifat-sifat umum yang dimiliki oleh \textit{Latin square} komutatif karena berhubungan dengan grup $S_n$.
