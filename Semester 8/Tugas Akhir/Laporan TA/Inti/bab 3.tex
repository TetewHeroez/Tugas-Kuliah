...
Pada tinjauan pustaka telah dijelaskan mengenai definisi dan teorema yang berkaitan dengan matriks aljabar max-plus. Selanjutnya, pada tahap ini dilakukan identifikasi mengenai \textit{Latin square} seperti apa yang dapat dikatakan komutatif terhadap operasi perkalian dalam aljabar max-plus. Menggunakan bantuan bahasa pemrograman Python, dilakukan pencarian dan identifikasi terhadap \textit{Latin square} komutatif berordo 1-5.

\section{Investigasi Sifat \textit{Latin square} Komutatif}
Kemudian, pada tahap ini dilakukan investigasi lebih mendalam mengenai kemiripan struktur dan sifat-sifat dari dua buah \textit{Latin square} komutatif yang telah diidentifikasi pada tahap sebelumnya.
Investigasi dilakukan dengan membandingkan struktur pasangan \textit{Latin square} komutatif menggunakan Proposisi \ref{eq:dekomposisi_latin_square} yang telah dijelaskan pada bab 2. Hal tersebut bertujuan untuk mememudahkan dalam menemukan sifat-sifat umum yang dimiliki oleh \textit{Latin square} komutatif karena berhubungan dengan grup $S_n$.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{|C{0.6cm}|L{6.5cm}|C{0.25cm}|C{0.25cm}|C{0.25cm}|C{0.25cm}|C{0.25cm}|C{0.25cm}|C{0.25cm}|C{0.25cm}|C{0.25cm}|C{0.25cm}|C{0.25cm}|C{0.25cm}|}	\hline
    ...
    4                                 & Penarikan kesimpulan                              &                                      &                        &                        &                   &                   &                   &                   & \cellcolor{blue!} & \cellcolor{blue!} & \cellcolor{blue!} &                   &                   \\\hline
    5                                 & Penulisan tugas akhir                             &                                      &                        &                        &                   &                   &                   &                   &                   &                   & \cellcolor{blue!} & \cellcolor{blue!} & \cellcolor{blue!} \\\hline
  \end{tabular}
\end{table}
