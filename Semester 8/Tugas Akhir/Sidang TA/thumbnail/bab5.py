...
class Bab5Thumbnail(Scene):
    def construct(self):
        # Background color
        self.camera.background_color = "#F3F4F6"
        ...
        self.play(Write(slide_1), run_time=0.75)
        self.wait(1)
        self.play(FadeOut(slide_1, shift=LEFT), run_time=0.5)
        
        # Lampiran (Tabel Rekapitulasi)
        ...
        self.play(Write(judul), Write(deskripsi), run_time=0.5)
        ...
        self.play(Create(box), Write(ket), run_time=0.5)
        self.wait(1)
        ...
        self.play(Transform(box, box_new), Transform(ket, ket_new), run_time=0.5)
        self.wait(1)
        ...
        self.play(Transform(box, box_new2), Transform(ket, ket_new2), run_time=0.5)
        self.wait(1)
        
        self.play(FadeOut(VGroup(judul, deskripsi, table, box, ket), scale=0.5), run_time=0.5)
        self.wait(0.5)
