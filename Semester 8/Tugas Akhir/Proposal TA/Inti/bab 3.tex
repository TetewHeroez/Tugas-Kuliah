...
Pada tinjauan pustaka telah dijelaskan mengenai definisi dan teorema yang berkaitan dengan matriks aljabar max-plus. Selanjutnya, pada tahap ini dilakukan identifikasi mengenai \textit{Latin square} seperti apa yang dapat dikatakan komutatif terhadap operasi perkalian dalam aljabar max-plus.
...
Investigasi ini dapat dilakukan dengan pendekatan analitik maupun eksperimental, misalnya dengan melakukan enumerasi terhadap \textit{Latin square} berordo kecil hingga menengah.
