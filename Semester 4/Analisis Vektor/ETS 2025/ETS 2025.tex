                ...
                \begin{center}
                  \begin{tikzpicture}
                    \begin{axis}[
                      ...
                      \addplot3 [dashed, gray, variable=t, samples y=0] ({2*sin(deg(t)) + 2}, {3*cos(deg(t))}, {0});
                      % Lintasan heliks / lintasan partikel
                      \addplot3 [thick, red, variable=t, samples y=0] ({2*sin(deg(t)) + 2}, {3*cos(deg(t))}, {t});
                    \end{axis}
                  \end{tikzpicture}
                \end{center}
                ...
                \begin{center}
                  \begin{tikzpicture}
                    \begin{axis}[
                      ...
                      % Sketsa bayangan parabola menempel secara konstan pada kurva cycloid
                      \addplot3 [dashed, gray, variable=t, samples y=0] ({0}, {1 - cos(deg(t))}, {4*sin(deg(t/2))});
                      % Kurva lintasan aktual 3D
