...
% DOCUMENT INFO
\title{\textbf{Aplikasi Transformasi Wavelet CDF 5/3 dan CDF 9/7 pada Standar Kompresi Citra JPEG2000}}
...
lossy. Kedua pasangan filter ini direalisasikan melalui \textit{lifting scheme} \cite{unser2003mathpropertieswavelet}.
\begin{figure}[H]
...
\textit{scalable bitstream} \cite{Attluri2006OptimizedRA}.
...
\section{Perbandingan JPEG dan JPEG2000 Berdasarkan MSE dan SSIM}
Pada bagian ini dilakukan evaluasi kuantitatif terhadap performa JPEG dan JPEG2000
menggunakan dua metrik objektif, yaitu
...
Hasil pengujian divisualisasikan pada grafik MSE--Rate dan SSIM--Rate.
...
\begin{itemize}
  \item Kurva JPEG menurun secara perlahan. Pada bitrate rendah ($\approx 0.10$--$0.25$ bpp),
