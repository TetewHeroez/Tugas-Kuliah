...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[
    ...
    % === Komponen Hasil ===
    \node[box, below left=of rgb.south east, xshift=-3.2cm, yshift=-0.3cm] (Y) {\includegraphics[width=3cm]{img/Y.png} \\ \textbf{Komponen Y}};
    \node[box, below=of rgb.south, yshift=-0.3cm] (Cb) {\includegraphics[width=3cm]{img/Co.png} \\ \textbf{Komponen Co}};
    \node[box, below right=of rgb.south west, xshift=3.2cm, yshift=-0.3cm] (Cr) {\includegraphics[width=3cm]{img/Cg.png} \\ \textbf{Komponen Cg}};
