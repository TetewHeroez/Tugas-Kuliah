...
\AtBeginSection[]
{
    ...
    \begin{frame}
        ...
        \begin{figure}
            ...
            \caption{Suroboyo Bus \cite{jawapos2024suroboyobus}}}
        \end{figure}
    ...
    \begin{frame}
        ...
        \begin{figure}
            ...
            \onslide<2->{\caption{Rute Suroboyo Bus \cite{wikipedia2024suroboyobus}}}
        \end{figure}
    ...
    \begin{frame}
        \frametitle{\insertsubsection}
        \begin{itemize}
            \item \onslide<2->{Penelitian ini hanya akan memodelkan rute lalu lintas Suroboyo Bus dengan menggunakan pendekatan aljabar max-plus.}
    ...
    \begin{frame}
        ...
        \begin{enumerate}
            \item \onslide<2->{Identifikasi Sistem Jaringan Suroboyo Bus}
            \item \onslide<3->{Modelkan sistem dalam graf berarah dan berbobot}
            \item \onslide<4->{Formulasikan sistem dalam aljabar max-plus}
            \item \onslide<5->{Selesaikan Model sistem dengan bantuan \textit{software Scilab}}
            \item \onslide<6->{Mendesain penjadwalan Suroboyo Bus}
        \end{enumerate}
    \end{frame}
    % \begin{frame}
